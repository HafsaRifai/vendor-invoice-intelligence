...
from inference.predicting_freight import predict_freight_cost
...
if selected_model == "Freight Cost Prediction":
    ...
    **Objective:**
    ...
    if submit_freight:
        ...
        prediction = predict_freight_cost(input_data)['Predicted_Freight'].values[0]
...
# ========================================================
    ...
    **Objective:**
    ...
    if submit_flag:
        ...
        flag_prediction = predict_invoice_flag(input_data)['Predicted_Flag'].values[0]
...
---
**Model Information:**
- 🎯 Invoice Flagging: 89% Accuracy | Random Forest Classifier
